...
(function() {
    window.LiveEditor = {
        ...
        isAdmin: function() {
            ...
            return u && (u.role === 'admin' || (u.email && u.email.toLowerCase() === 'prof.memmo@gmail.com'));
        },
        ...
        // Render o aggiorna il floating badge per l'Admin
        renderFloatingBadge: function() {
            ...
            badge.title = "Fai click per visualizzare o inserire correzioni al volo nei testi didattici";
            
            badge.onmouseenter = () => badge.style.transform = 'scale(1.05)';
            badge.onmouseleave = () => badge.style.transform = 'scale(1)';
            badge.onclick = () => {
                const key = prompt("✏️ Inserisci l'ID o la chiave dell'esercizio da modificare (oppure clicca sulla matita accanto alla domanda):", "");
            ...
            modal.innerHTML = `
                <div class="modal-content" style="background: white; border-radius: 24px; width: 100%; max-width: 600px; padding: 25px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.3); font-family: inherit; position: relative;">
                    ...
                    <p style="font-size: 0.85rem; color: #64748b; margin-top: 0; margin-bottom: 15px;">
                        Le modifiche salvate verranno applicate <strong>istantaneamente per tutti gli studenti</strong> via cloud nell'Hub, lasciando intatti i file su GitHub.
                    </p>
                    ...
                    <form onsubmit="event.preventDefault(); LiveEditor.save('${itemKey}');">
                        ...
                        <div style="margin-bottom: 15px;">
                            <label style="display: block; font-weight: 700; font-size: 0.85rem; color: #334155; margin-bottom: 5px;">Risposta Corretta / Soluzione (opzionale):</label>
                        ...
                        <div style="margin-bottom: 20px;">
                            <label style="display: block; font-weight: 700; font-size: 0.85rem; color: #334155; margin-bottom: 5px;">Spiegazione Didattica / Suggerimento (opzionale):</label>
    ...
    // Controllo periodico per session hydration
    setInterval(() => {
