    ...
    renderPersonalityTest: (exercise, isUda, path, total) => {
        ...
        return `
            <div class="exercise-container">
                ...
                <button class="btn btn-primary btn-verify" style="width: 100%; padding: 1.5rem; font-size: 1.25rem; font-weight: 800; margin-top: 1rem; margin-bottom: 2rem; border-radius: 20px; box-shadow: 0 10px 20px rgba(0,0,0,0.05);" onclick="UI.verifyPersonalityTest(${exercise.id}, ${(exercise.questions || []).length})">SCOPRI IL TUO PROFILO 🔍</button>
